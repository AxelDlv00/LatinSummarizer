...
preexisting_checkpoint_path = "/Data/AxelDlv/mt5-small-en-la-translation/mt5-small-en-la-translation-final_with_stanza-epoch-5.pt"  # Leave empty if not using a previous checkpoint
